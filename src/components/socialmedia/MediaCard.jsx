...
export default function MediaCard({ icon, explanation, type, url }){
  return (
      	<a href={url} className="block bg-white h-fit rounded-lg transition-transform ease-in-out hover:cursor-pointer hover:-translate-y-3 hover:-translate-x-3 p-2">
