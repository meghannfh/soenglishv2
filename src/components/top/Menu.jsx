...
/*have the height & text dynamically switch to screen and text 3xl only when it is shown */
  return(
    <div className="w-screen rainbow-bg md:h-20 md:flex md:justify-center">
      <ul className="flex flex-col pt-6 pb-20 h-screen w-full text-2xl md:gap-0 md:text-xl md:p-0 md:flex-row md:flex-wrap md:gap-x-6 md:w-[470px] md:h-full md:justify-center lg:gap-6 lg:items-center lg:w-full lg:text-xl menu-list">
        <li>
