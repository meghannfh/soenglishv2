...
export default function ContactSection(){
  return(
    <div id="section8" className='w-full px-6 py-10 md:px-20 bg-blue-100'>
      <h2 className="mb-0 text-blue-600">Contact</h2>
      <div className="mt-6 w-full flex flex-col md:flex-row gap-10">
        <div className='md:w-1/2 flex flex-col justify-start items-center'>
          <p className="mt-0 indent">有料カウンセリングの申し込みを含むお問い合わせは、LINEをお持ちの方なら、より早く返信が可能ですので、<a href="https://lin.ee/4NUjdB9" className="underline text-blue-500">こちら</a>をクリックするか、QRコードより公式LINEに友達追加の上、ご連絡を頂けると幸いです。以下、メールでやり取りを希望される方は、フォームにご記入をお願いいたします。</p>
