...
export default function ContactSection(){
    return(
      <div id="section8">
        <div className='w-full px-6 py-10 md:px-24 gap-2 bg-blue-100 flex flex-col lg:flex-row items-center justify-between'>
          <div className='lg:w-1/3'>
            <h2 className="text-3xl md:text-3xl font-semibold text-blue-600">Contact</h2>
