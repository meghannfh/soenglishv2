    ...
    <div id="section8" className='w-full px-6 py-24 md:px-40 bg-blue-100'>
      ...
      <div className="mt-6 w-full flex flex-col md:flex-row gap-10">
        <div className='md:w-1/2 flex flex-col justify-start items-center'>
          <p className='indent-5 font-medium text-slate-900 leading-relaxed md:leading-loose text-lg'>有料カウンセリングの申し込みを含むお問い合わせは、LINEをお持ちの方なら、より早く返信が可能ですので、QRコードより公式LINEに友達追加の上、ご連絡を頂けると幸いです。以下、メールでやり取りを希望される方は、フォームにご記入をお願いいたします。</p>
