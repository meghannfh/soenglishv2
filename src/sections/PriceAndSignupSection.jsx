...
export default function PriceAndSignupSection(){
 ...
 const paragraphs = [
    ...
    },
    {
        'subtitle': 'レッスン受講方法',
        'text': [
          '英語プライベートコーチング・レッスン、グループセッション、LGBT個別相談等を受講希望する方々には、まずは90分単発有料カウンセリングを必ず受けて頂いております(ワークショップはカウンセリング未受講者も受けていただけます)。双方が納得のいった形で、きちんとスタートした方が効果があるからです。',
          '通常こういったスクールには入会費があります。入会費を支払うことは覚悟を決めることと同義ですから、その方がモチベーションと学習効果が上がります。',
          'SO ENGLISH!では、入会費をいただかない代わりに、カウンセリングを必ず受けて頂いているのです。ね、こう聞くとただ入会費を支払うよりも、90分もカウンセリングをして、しかもこれからやるべきことが見えるのですから、お得じゃないですか?',
          'とはいえ長年考え、授業の質の向上と学習者のモチベーション維持の為にも、薄利多売はしません。ただ、未来ある若者(25歳以下)には、多少の割引をさせていただきます。私から日本の未来への投資です。',
        ]
      },
      {
        'subtitle': '90分単発有料カウンセリングにつきまして',
        'text': [
          '単発有料カウンセリングでは、90分の時間の中で、新たな取り組みをする理由を聞き、深く話をする過程で、10年以上の講師経験を元に、適格な目標設定、所要期間の算出、教材の選択、オリジナルのトレーニングメニューを作成するものです。',
  ...
  return(
    <div className="w-full bg-white pb-10" id="section7">
      <div className="px-6 sm:px-10 py-10 md:px-0 md:mx-20 lg:mx-40 xl:mx-60">
        <h2 className="text-2xl md:text-3xl font-semibold text-lime-500">料金形態と受講方法(単発90分有料カウンセリングの受け方)</h2>
