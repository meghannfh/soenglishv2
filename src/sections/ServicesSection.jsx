    ...
    const services = [
        ...
        },
        {
            ...
            'feedback': [
                {
                    'studentName': 'Tさん',
                    'comment': `☆自分がよくできたところ<br/>
                    発音を意識しながら大きな声ではっきりと音読や発音練習ができました。
                    <br/>
                    ☆次回やりたいこと<br/>
                    ジェスチャーもたくさん入れて、もっと感情豊かに話せるようにする。
                    <br/>
                    ☆今日学んだところ<br/>
                    会話の出だしや、会話の受け答えには 決まったパターンがあるのでそれを覚えていくと 会話がよりいっそう弾むことがよくわかりました。<br/>
                    <br/>
                    ☆感想<br/>
                    今日はNewメンバーで新鮮でした。<br/>
                    だれを同じグループになっても毎回楽しい レッスンで、あっという間に終ってしまいます。 今日習ったことを少しでもたくさん覚えて、日常で使えるようになりたいです。ありがとうございました。`
                },
                {
                    'studentName': 'Rさん',
                    'comment': `(良く出来た事)<br/>
                    ...
                    <br/>
                    (改善点)<br/>
                    ・ジェスチャーももっと大きく出来れば良かった。<br/>
                    ・一言で英文を終わらせずもっと話しても良かった。<br/>
                    <br/>
                    (感想)<br/>
                    ・想像力を使って文を考えるのが難しかった。<br/>
                    ・みんなで話している時は積極的に話せる時もあったが、マンツーマンになった場合に上手く話そうとしてしまったので気をつけたいと思いました。<br/>
                    ・とても良い雰囲気のレッスンで楽しかったです。ありがとうご ざいました。`
                },
                {
                    'studentName': 'Mさん',
                    'comment': `今日もグループレッスンありがとうございました。
                    会話はなりきって練習するのと、どんな場面なのか想像して練習する ことにより、より自分の言葉として入って来ました。課題はご指摘いただいたとおり間をあけず、パン、パン、パンと言えるように意識して練習します。ありがとうございました!`
                },
            ]
        },
        {
            ...
            'feedback': [
                {
                    'studentName': 'Uさん',
                    'comment': `先日はワークショップありがとうございました。
                    想像をはるかに越えた内容だったので、これだけのものを準備するのにどれほど時間がかかったのかと思うと本当に有難い講座でした!下から山を登って頂上が見えず模索している状態でしたが、ドローンで 上から見渡したような気持ちになれました〜。自分の現在地やいろいろ考え方や勉強方があるのがわかりました(^-^)特に手続き的知識は英語以外にも自分の生き方や仕事にも取り入れたい と思います !いつも新しい視点を教えて頂いてありがとうございます。`
                },
                {
                    'studentName': 'Jさん',
                    'comment': `ワークショップに参加させていただき、 ありがとうございました。
                ...
                {
                    'studentName': 'Eさん',
                    'comment': `SO先生、 ワークショップありがとうございました!3回も参加させていただき本当にありがとうございました。何をやろう?どうすれば?というところがスゴく明確になったのと、自分のレベルを改めて見つめ直す機会になりました。<br/>
                    1回目、参加した時は、手続き的知識ばかりに意識がいってましたが、2回目で、いや、そもそも私、宣言的知識が全く足りてなくない?というところに気づけました。なので、初心者用の単語帳も文法書も買いました笑<br/>勉強を始めた当初は、いきなり英検2級レベルの単語帳を買って挫折した)<br/>あと、どうせ英語を話すならカッコよく話したい欲もあるので、発音も 良くなりたいと思っていました。 (個人的にモノマネは楽しくて好き)フォニックスのルールを知っているかいないかで大きく変わるなぁと 感じています。 フォニックスは毎日、練習しようと思います!`
                },
                {
                    'studentName': 'Tさん',
                ...
                {
                    'studentName': 'Kさん',
                    'comment': `そう先生。おはようございます。改めまして昨夜のワークショップ、 遅くまで沢山のお話、ありがとうございました。改めまして感想を。英語学習、 一人(独学)じゃ無理やな。を実感しました。引き続きよろしくお願いします。
                    英語に触れることで得られる本質を見つめ続けて、今年も日々精進し、英語道を邁進したいと思います。新しい1年、改めてよろしくお願いします.`
                },
                {
                    'studentName': 'Nさん',
        ...
        },
        {
            ...
            'feedback': [
                ...
                `そう先生、いつも楽しい話をありがとうございます！`,
                `疲れ切ってるコロナ生活の中、so先生のレッスンは救いような存在です。気楽になんでも話せて楽しかったのです。`,
                `So先生がベルギーにいる最後のレッスンで、なんだかこっちも少々寂しくなった気分だったが、先生が日本に戻ったら、時差なしでレッスン受けれることを考えたら、待ちきれないのです。^_^いつも友達と余談している気分で、お互いに趣味のことをシェアしたり、身の回りに起きた出来事を話したりして、こんなに物事の考え方が一緒な人って、親友以外初めて出会いました。このアプリをダウンロードしたのは偶然だったし、So先生のレッスンを予約したのも「一か八か」という気持ちだったけれど、これらの偶然のピースを一つずつ合わせ、必然に導いてくれたと信じてます。この「一期一会」をこれからも大事にしていきたいと思います。`,
                `Thank you, So, for another great lesson. We talked about a variety of topics, and reviewed a pair of similar words that came up in a previous lesson. Even though he had already explained it before, he still patiently went through numerous sample sentences with me. I'm finding that through our lessons, I'm learning more and more about various cultural aspects of Japan. If you're looking for a dynamic, engaging, and extremely qualified teacher, you should try a lesson with So!<br/><br/>(訳)Soさん、今回も素晴らしいレッスンをありがとうございました。様々なトピックについて話し、前のレッスンで出てきた似たような単語のペアを復習しました。前に説明したことがあるにもかかわらず、それでも根気よく何度もサンプル文を一緒に見てくれました。レッスンの中で、日本の様々な文化的側面について、どんどん学んでいることを実感しています。ダイナミックで、魅力的で、非常に優秀な先生を探しているのなら、ぜひSo先生のレッスンを受けてみてください!`,
                ...
                `初めてのレッスンで、少々不慣れなところはありましたが、普段日本語会話する機会が全くない私に友達のように話してくれて、楽しかったです。言語って、やはり面白いだなぁと改めて思わせてくれました。本当にありがとうございました。`,
                `いつもありがとうございます。何でも話題ならお話しが出来てとても嬉しいです。これからもカジュアルな日本語を練習していきましょう＾＾`,
                `So先生は素晴らしいです!友達のようになんでも話せます。先生ともっと話すために、日本語を勉強しないと^ ^`,
                `I appreciate how kind So Sensei is and just how patient they were with my choppy Japanese. I felt supported to try again and was provided corrections after the session.<br/><br/>(訳)So先生はとても親切で、私のたどたどしい日本語にどれだけ耐えてくれたか、感謝しています。また、セッションの後に添削をしていただき、再チャレンジのサポートをしていただきました。`
            ]
        },
        {
            ...
            'feedback': [
                '毎回、衝撃的（笑撃的）で、３つに絞るのは地獄。なくらい楽しみにしてます。',
                `That's so carrot の大ファンのつもりでしたが、まだこんなに聞いてないエピソードがあったなんて、ファンとして恥ずかしいわ！でもまだ聞いてないエピソードがあると、まだまだ聞く楽しみがあって嬉しくもあります笑<br/><br/>お二人の価値観には共感するばかりだし、聞きながらいつもとても元気をもらってます。あ！外で聞く時は、つい笑っちゃうからニヤニヤした顔を隠すためにマスクが必須です！笑`,
                '軽い感じでズバリ必要なこと重要なことをありがとうございます🌈🌏',
                'Soくんとキャロちゃんの深くて厚い信頼が、こちらまで届きます。笑顔になれるラジオをありがとう。',
                'いつも2人のトークから色んな知識をもらったり、多様性ってなんだろって一緒に考えさせてもらったり、兎に角受け身ではなく、自分もその場にいる様な感じで、本当にお気に入りPodcast!<br/><br/>2人のトークが押し付けなく、分からないことは『教えて』とか知らないことを恥じてないところや、素直に聞き合う姿勢がとても好き。2人の様な関係性が、もっと他の人にもできたらなって思う、それくらい2人のやり取りに癒される!いつもありがとう！',
                '内容じゃなくてごめんなさい。でも、2人とも、耳心地が良い声してます!',
                '二人の掛け合いが最高！いろんな視点からの話が面白い！',
                'お2人の柔らかい話し方と声が好きです^_^キャロ先生の「〇〇したいと思いまぁーーす♪」っていう言い方が特に好きで隠れファンです。よくこんなにも話題が出てくるなぁと思うくらい話題豊富なお2人。きっと色々な事に興味があって意識していて、日々を大切に過ごしているからなんだなぁと思います。ラジオをずっと続けていることもすごいですよね。英語学習もですが、続けることの大切さを教えてもらっている気がします^_^',
                'なにかをしながら聴くというよりは、一言も聴き逃したくない〜という想いで、気がつけばいつも ものすごく集中して聴かせていただいています。お二人のお話がほんとうに好きです🎶',
                '毎回、楽しく聴かせてもらってます！週一での更新大変だと思いますがこれからも楽しみに待ってまーす！',
                '毎回、散歩しながらか、車の運転中、楽しみに聞いています。毎回、勉強になり、自分の考え方とか、視野が広がりました。これからも楽しみにしてます！',
                'お二人がいつも明るくて元気を頂いてます！自分にない視点も聞けるのでとってもためになります。',
                'いつも、いつも面白くて、楽しくて、聞いてると心がホッコリ暖かくなるラジオをありがとうございます!このラジオはなぜだか、私の英語学習の1番のモチベーションになるんです!笑聞き終えるともう次の回が早く来ないかなぁーと楽しみになります^^このラジオを通して、お会いした事はないけれど、なぜだかお会いした気持ちになってしまう素晴らしいリスナーさん達!いつかほんとにお会いしたいです♡お2人はお仕事もやりながらのラジオで大変だと思いますが、出来れば毎週土曜日聴きたいですが笑無理なくお2人のペースでラジオ楽しんで下さいねー♡',
                'お二人の、ゆるくもあり、真剣なトークに、共感したり、そういう考え方もあるかぁ〜と、価値観の幅?を広げてもらったり、とても楽しく拝聴しています。これからも、楽しみにしています!ちなみに、私はYouTube派です。お二人の笑顔にとても癒やされます!',
                '毎回、いっぱいポジティブになってモチベーションが上がります。電車の中でもどこでも、聴いている時…自分が＂微笑み顔＂なっていることに、先日気づきました！笑お二人の会話、雰囲気がとても楽しくて好きです^_^',
                'お二人のラジオ、本当に聴き心地が良いです。英語のことからいろんな方面に話題に広がり、いつの間にやら毎回のeducational channel。英語、海外の知識だけでなく、物事の捉え方、考え方まで、いろんなことを教えてもらっています。お二人が同年代ということで、ドンピシャな話題が多々。人生豊かにしていただきありがとうございます!',
                'いつも、英語学習だけでなく人生においても元気、やる気、勇気をもらっています！',
            ]
        },
        {
            'service' : `12. その他の仕事`,
