...
export default function SoRainbowSection(){
  ...
  const soRainbowImg = [
    ...
    return(
        ...
        <div className="flex flex-col px-6 py-24 md:px-24 bg-black/10">
          <h2 className="mb-10 text-5xl md:text-4xl font-semibold text-white">SO RAINBOW!<br/> 私が使命感を持って取り組んだもう一つの仕事～「日本だから結婚できない」と思われている方へ～</h2>
