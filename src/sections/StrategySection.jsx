  ...
  const paragraphs = [
    {
      ...
      'imgURL': 'https://res.cloudinary.com/dc1aiqs4p/image/upload/v1688512077/%E3%82%A2%E3%83%9B%E3%82%9A%E3%83%BC_210_80_mm_196.4_80_mm_196.4_120_mm_ocywhk.webp',
      'subcategories': [
        {
      ...
      'contentList': [
        {
          ...
          'contentMedia': [
            ...
            {
              'title': '公式LINE',
              'imgUrl': 'https://res.cloudinary.com/dc1aiqs4p/image/upload/v1689608965/Lineedit2_lstghl.webp',
            ...
            },
            {
              ...
              'imgUrl': 'https://res.cloudinary.com/dc1aiqs4p/image/upload/c_thumb,w_460,g_auto/v1690518102/ytedit2update_bx7lqr.webp',
        ...
        },
        {
          'listTitle': '複数人用',
          'contentList': [
            'グループセッション(英会話・非言語トレーニング・翻訳・音読・発音など)',
            'ワークショップ(学習法・マインド)',
    ...
    },
    {
      'subtitle': '5. 密な対話',
      'text': [
        'どんなに素晴らしいカリキュラムや教材やトレーニングがあっても、成果が出るまでの継続が難しいことは、きっと説明不要ですね。チャレンジしているということは、いくつもの壁にぶち当たることと同義です。その壁を乗り越えた先に大きな成長が待っていますが、目の前の壁の高さの想像もつかず、残念ながらここで諦めてしまう方は多いです。私の仕事の一つは、その壁の高さを伝え、学習者の気持ちを軽くしたり、それが本当に越えたい壁なのかを問うことだと思っています。ある程度の本音での対話が必要で、その為に私自身をさらけ出すことを意識しています。',
        '少しずつ本音を出してくれるようになる生徒との対話の中で、努力の末に成長を実感し嬉し涙を流してくれる方や、人生の相談をしてくれる方もいます。たまに、授業が終わった時には、予定していた内容とまったく異なってしまった、ということもありますが、そのような柔軟さも大切だと思っています。人と人の対話は流動的なもので、いつも目の前の人に真剣でありたい。その結果「二度は再現できないレッスン」になっているのだと思います。'
      ],
    }
  ]
  return(
    <div id="section4" className="bg-orange-100">
      <div className="px-6 sm:px-10 py-10 md:px-0 md:mx-20 lg:mx-40 xl:mx-60">
        <h2 className="text-orange-600">SO's STRATEGY<br/>どうやって英語を話せるようになるの？</h2>
        <StrategyCards />
        { paragraphs ? paragraphs.map((paragraph, idx) => (
          <div key={idx}>
            <StrategyTextbox 
              ...
              contentList={paragraph.contentList && paragraph.contentList}
          />
          </div>
        )) : 'nada'}
      </div>
